...
#Region "Declarations"
    ...
    Private ReadOnly _Font As Font = New Font("Linux Biolinum G", _FontSize)
    ...
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        ...
        ElseIf MouseXLoc > Width - 89 AndAlso MouseXLoc < Width - 66 AndAlso MouseYLoc < 22 Then
            If _AllowMinimize Then
                ...
                End Select
            End If
        ElseIf e.Button = System.Windows.Forms.MouseButtons.Left And New Rectangle(0, 0, Width - 90, MoveHeight).Contains(e.Location) Then
        ...
        ElseIf e.Button = System.Windows.Forms.MouseButtons.Left And New Rectangle(Width - 90, 22, 75, 13).Contains(e.Location) Then
            CaptureMovement = True
            MouseP = e.Location
        ElseIf e.Button = System.Windows.Forms.MouseButtons.Left And New Rectangle(Width - 15, 0, 15, MoveHeight).Contains(e.Location) Then
            CaptureMovement = True
            MouseP = e.Location
        Else
            Focus()
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillRectangle(New SolidBrush(_ContainerColour), New Rectangle(2, 45, Width - 4, Height - 32))
            ...
            Select Case State
                Case MouseState.Over
                    If MouseXLoc > Width - 39 AndAlso MouseXLoc < Width - 16 AndAlso MouseYLoc < 22 Then
                        If _AllowClose Then
                            .FillRectangle(New SolidBrush(Color.FromArgb(203, 40, 33)), New Rectangle(Width - 39, 0, 23, 22))
                        End If
                    ElseIf MouseXLoc > Width - 64 AndAlso MouseXLoc < Width - 41 AndAlso MouseYLoc < 22 Then
                        If _AllowMaximize Then
...
#Region "Declarations"
    ...
    Private _BorderColour As Color = Color.FromArgb(35, 35, 35)
    Private _HoverColour As Color = Color.FromArgb(154, 104, 11)
    Private _PressedColour As Color = Color.FromArgb(154, 104, 29)
    Private _NormalColour As Color = Color.FromArgb(184, 134, 11)
#End Region
...
Public Class XRadialProgressBar
    Inherits Control

#Region "Declarations"
    Private _BorderColour As Color = Color.FromArgb(35, 35, 35)
    Private _BaseColour As Color = Color.FromArgb(42, 42, 42)
    Private _ProgressColour As Color = Color.FromArgb(184, 134, 11)
...
#Region "Colour & Other Properties"
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is XRadioButton Then
                DirectCast(C, XRadioButton).Checked = False
                Invalidate()
            End If
        Next
    End Sub
...
Public Class XButtonWithProgress
    Inherits Control
...
#Region "Variables"
    ...
    Private _BorderColour As Color = Color.FromArgb(35, 35, 35)
    Private _SecondBorderColour As Color = Color.FromArgb(184, 134, 11)
    Private _FontColour As Color = Color.FromArgb(255, 255, 255)
...
#Region "Draw Control"
    ...
    Sub New()
        Renderer = New ToolStripProfessionalRenderer(New XColourTable())
...
#Region "Declarations"
    ...
    Private _SecondColour As Color = Color.FromArgb(154, 104, 29)
    Private _Value As Integer = 0
    Private _Maximum As Integer = 100
...
#Region "Variables"
    ...
    Private _RectColour As Color = Color.FromArgb(111, 75, 21)
...
#Region "Declarations"
    ...
    Private _ToggledColour As Color = Color.FromArgb(111, 75, 21)
...
#Region "Declarations"
    ...
    Private _BaseColour As Color = Color.FromArgb(42, 42, 42)
    Private _FontColour As Color = Color.FromArgb(255, 255, 255)
    Private _LineColour As Color = Color.FromArgb(111, 75, 21)
...
#Region "Declarations"
    ...
    Private _UpLineColour As Color = Color.FromArgb(184, 134, 11)
    Private _HorizLineColour As Color = Color.FromArgb(111, 75, 21)
...
#Region "Declaration"
    ...
    Private _StripAmountColour As Color = Color.FromArgb(111, 75, 21)
#End Region
...
<DefaultEvent("Scroll")>
Public Class XVerticalScrollBar
    Inherits Control
...
<DefaultEvent("Scroll")>
Public Class XHorizontalScrollBar
    Inherits Control
...
Public Class XTitledListBoxWBuiltInScrollBar
    Inherits Control

#Region "Declarations"

    Private _Items As New List(Of XListBoxItem)
    Private ReadOnly _SelectedItems As New List(Of XListBoxItem)
    Private _MultiSelect As Boolean = True
    Private ItemHeight As Integer = 24
    Private ReadOnly VerticalScrollbar As XVerticalScrollBar
...
#Region "Properties & Events"
    ...
    Public Property Items() As XListBoxItem()
        Get
            Return _Items.ToArray()
        End Get
        Set(ByVal value As XListBoxItem())
            _Items = New List(Of XListBoxItem)(value)
            InvalidateScroll()
        End Set
    End Property

    Public ReadOnly Property SelectedItems() As XListBoxItem()
        Get
    ...
    Public Sub RemoveItem(ByVal item As XListBoxItem)
        _Items.Remove(item)
        InvalidateScroll()
    End Sub

    Public Sub RemoveItems(ByVal items As XListBoxItem())
        For Each I As XListBoxItem In items
            _Items.Remove(I)
        Next
        InvalidateScroll()
    End Sub
...
#Region "Draw Control"
    ...
    Sub New()
        SetStyle(ControlStyles.OptimizedDoubleBuffer Or ControlStyles.AllPaintingInWmPaint Or ControlStyles.ResizeRedraw Or
                    ...
                    ControlStyles.SupportsTransparentBackColor, True)
        DoubleBuffered = True
        VerticalScrollbar = New XVerticalScrollBar
        VerticalScrollbar.SmallChange = ItemHeight
        VerticalScrollbar.LargeChange = ItemHeight
...
Public Class XListBoxWBuiltInScrollBar
    Inherits Control
